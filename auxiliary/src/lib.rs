...
//pub type Lsm303agr = lsm303agr::Lsm303agr<I2c<I2C1, (PB6<AF4>, PB7<AF4>)>, lsm303agr::mode::MagContinuous>;
pub type Lsm303agr = lsm303agr::Lsm303agr<lsm303agr::interface::I2cInterface<I2c<I2C1, (PB6<AF4>, PB7<AF4>)>>, lsm303agr::mode::MagContinuous>;
...
pub fn init() -> (Leds, Lsm303agr, Delay, ITM) {
    ...
    // inside init():
    let lsm303agr = lsm303agr::Lsm303agr::new_with_i2c(i2c)
        .into_mag_continuous()
        .ok()
        .unwrap();
